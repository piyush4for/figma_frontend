...
const FooterComponent = () => {
  return (
    <div style={{ backgroundImage: `url(${footerImage.src})`,backgroundPositionY:-100,backgroundRepeat:'no-repeat' }}>
        <footer className="px-4 divide-y" >
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0" >
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className=" ml-11">
					<Image src='/images/FormLogo.png'/>
				<div className='font-sans text-red-600 font-w-7'>The NFT Marketplace for Fine Wines</div>
				</div>
